...
const Help = () => {
  return (
    <div className="sm:w-[360px] w-full bg-[#fff7ed] rounded-xl py-8 px-6 flex justify-between text-[#7f2d07]">
      <div>
        <span className="text-lg font-semibold block mb-1">Need help?</span>
        <span className="text-sm sm:text-base">We're here to help, 24*7</span>
